...
PLACE_CATALOG = [
    {"id": "home", "title": "Home", "keywords": ["home", "~"], "icon": "user-home", "env": "HOME"},
    {"id": "desktop", "title": "Desktop", "keywords": ["desktop"], "icon": "user-desktop", "xdg": "XDG_DESKTOP_DIR"},
    {
        "id": "documents",
        "title": "Documents",
    ...
    {"id": "music", "title": "Music", "keywords": ["music", "audio"], "icon": "folder-music", "xdg": "XDG_MUSIC_DIR"},
    {
        "id": "pictures",
        "title": "Pictures",
